//! embassy-shell over the USB Serial/JTAG peripheral of an ESP32-C3.
//!
//! The ESP32-C3 has no USB-OTG controller: its "USB console" is the built-in
...
async fn shell_task(
    ...
    let _ = embedded_io_async::Write::write_all(
        &mut tx,
        b"\r\nembassy-shell on ESP32-C3 (USB Serial/JTAG)\r\n",
    )
    .await;
    loop {
