//! embassy-shell over UART0 on an ESP32-C6.
//!
//! Console: UART0, GPIO16 = TX, GPIO17 = RX, 115200 8N1.
...
async fn main(spawner: Spawner) -> ! {
    ...
    log!("embassy-shell started on UART0 (TX=GPIO16, RX=GPIO17)");
